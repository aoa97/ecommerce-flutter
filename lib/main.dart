        ...
        child: MaterialApp(
          ...
          theme: ThemeData(
              ...
              textTheme: const TextTheme(
                headline1:
                    TextStyle(fontWeight: FontWeight.w700, fontSize: 34, color: Palette.black),
                headline2:
                    TextStyle(fontWeight: FontWeight.w600, fontSize: 24, color: Palette.black),
                headline3:
                    TextStyle(fontWeight: FontWeight.w500, fontSize: 18, color: Palette.black),
                headline4:
                    TextStyle(fontWeight: FontWeight.w400, fontSize: 16, color: Palette.black),
